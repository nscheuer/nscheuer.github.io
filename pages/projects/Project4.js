const Project4 = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('h2', { style: h2Style }, 'BSc. Mechanical Engineering at ETHz'),
      React.createElement(
        'div',
      ...
      React.createElement('p', { style: pStyle }, 'Learning various programming languages for different applications, such as embedded systems, robotics, control systems, data analysis, and machine learning.')
    ),
    React.createElement('img', {
      src: '../../~nscheuer/assets/images/projects/ethstudies.jpg',
      alt: 'Project 4',
